...
public class TerminarPedido extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn = (Button) findViewById(R.id.button_terminar);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                terminar_pedido(getIntent().getIntExtra("id", -1), id_mecanico);
            }
        });
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if(status) {
                                ...
                                Toast.makeText(TerminarPedido.this, "" + status, Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TerminarPedido.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        MySingleton.getInstance(this).addToRequestQueue(jsObjRequest);
    }

    public void terminar_pedido(int id_pedido, final int id_mecanico) {
        String url = "https://inactive-mosses.000webhostapp.com/myslim/api/pedidos/edita_pedido/" + id_pedido;

        Map<String, String> jsonParams = new HashMap<String, String>();
        jsonParams.put("if_terminado", String.valueOf(1));
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getBoolean("status")) {
                                ...
                                set_mecanico_disponivel(id_mecanico);
    ...
    public void set_mecanico_disponivel(int id_mecanico) {
        String url = "https://inactive-mosses.000webhostapp.com/myslim/api/pedidos/edita_mecanico/" + id_mecanico;

        Map<String, String> jsonParams = new HashMap<String, String>();
        jsonParams.put("if_disponivel", String.valueOf(1));
        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST, url,
                new JSONObject(jsonParams),
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getBoolean("status")) {
                                // Toast.makeText(PerfilCliente.this,response.getString("MSG") , Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(TerminarPedido.this, PedidosMecanico.class);
